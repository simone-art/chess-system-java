...
public class Pawn extends ChessPiece {
	...
	public boolean[][] possibleMoves() {
		...
		if (getColor() == Color.WHITE) {
			...
			if (getBoard().positionExits(p) && !getBoard().thereIsAPiece(p) && getBoard().positionExits(p2)
			...
			if (position.getRow() == 3) {
				...
				if (getBoard().positionExits(left) && isThereOpponentPiece(left)
				...
				if (getBoard().positionExits(rigth) && isThereOpponentPiece(rigth)
